...
public class Ozone {
    ...
    private void registerPackets(RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToClient(ChunkClaimPacket.DeleteSurveyorTableLocation.TYPE, ChunkClaimPacket.DeleteSurveyorTableLocation.STREAM_CODEC, ChunkClaimPacket.DeleteSurveyorTableLocation::execute);
